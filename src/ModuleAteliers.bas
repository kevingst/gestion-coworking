Attribute VB_Name = "ModuleAteliers"
' =============================================================================
' Module : ModuleAteliers
' Description : Gestion des ateliers — création et enregistrement
' =============================================================================

' Liste des thèmes disponibles pour les ateliers
...
Public Function EnregistrerAtelier(nom As String, dateStr As String, _
    ...
    ' Calcul du prochain ID (auto-incrémenté)
    nouvelID = 1
...
' -----------------------------------------------------------------------------
' RecalculerNbParticipants : Recalcule et met à jour Nb_Participants et
' Nb_Participants_Pro pour un atelier donné
' Paramètre :
'   idAtelier : L'ID de l'atelier à recalculer
' -----------------------------------------------------------------------------
Public Sub RecalculerNbParticipants(idAtelier As Long)
    ...
    ' Compter les présences pour cet atelier
    nbTotal = 0
    nbPro = 0
    ...
    ' Mettre à jour la ligne de l'atelier dans TblAteliers
    wsAteliers.Unprotect Password:=MOT_DE_PASSE
